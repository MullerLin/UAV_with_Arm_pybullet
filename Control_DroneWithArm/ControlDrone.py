...
drone = p.loadURDF(os.path.dirname(os.path.abspath(__file__))+"/asset/grasp_drone_2.urdf",  startPos, startOrientation, useFixedBase=False)
...
p.changeVisualShape(drone, 11, rgbaColor=[1, 1, 0.75, 0.5])
