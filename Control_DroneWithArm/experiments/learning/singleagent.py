...
if __name__ == "__main__":
    ...
    parser.add_argument('--env',        default='tune',      type=str,             choices=['takeoff', 'hover', 'flythrugate', 'tune'], help='Task (default: hover)', metavar='')
    ...
    parser.add_argument('--act',        default='tun',  type=ActionType,                                                           help='Action space (default: one_d_rpm)', metavar='')
    ...
    model.learn(total_timesteps=50000, #int(1e12),
    ...
    data = load(filename + '/evaluations.npz')
    lst = data.files
    for item in lst:
        print(item)
        print(data[item])
