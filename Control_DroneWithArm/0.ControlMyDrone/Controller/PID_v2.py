...
class DroneControl(object):
    def __init__(self,
        ...
        self.P_COEFF_FOR = np.array([1000, 2500, 1000])
        self.I_COEFF_FOR = np.array([1000, 200, 1500])
        self.D_COEFF_FOR = np.array([20, 20, 30])
        self.P_COEFF_TOR = np.array([.4, .8, .5])
        self.I_COEFF_TOR = np.array([.0001, .0001, .0001])
        self.D_COEFF_TOR = np.array([.25, .25, .25])
    ...
    def computeControlFromState(self,
        ...
        target_force, target_rpy, pos_e = self._simplePIDPositionControl(control_timestep = control_timestep,
                                                                            cur_pos = cur_pos,
                                                                            cur_quat = cur_quat,
                                                                            target_pos = target_pos,
                                                                            target_rpy=target_rpy
        ...
        return target_force, target_torques, target_rpy, pos_e, rpy_e
    ...
    def _simplePIDPositionControl(self,
        ...
        return  target_force, target_rpy, pos_e
    ...
    def _simplePIDAttitudeControl(self,
        ...
        #print("[INFO] integral_rpy_e: ", self.integral_rpy_e)
        #### PID target torques ####################################
